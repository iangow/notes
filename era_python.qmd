...
Sys.setenv(DATA_DIR= "/mnt/samsung/data/Dropbox/pq_data")
```
...
dsf = con.read_parquet(data_dir + "/crsp/dsf.parquet")
stocknames = con.read_parquet(data_dir + "/crsp/stocknames.parquet")
```
