...
For example, details about the IPO Galmed Pharmaceuticals Ltd. (GLMD) on 13 March 2014 can be found [here](https://www.nasdaq.com/market-activity/ipos/overview?dealId=926632-74581).
...
We get data on auditors and IPOs from the IPO data and store it in `ipo_auditors`.
...
name_matches: 397 x 8
deal_matches: 404 x 12
 extra_deals: 2 x 8
```
