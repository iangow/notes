...
load_parquet <- function (conn, table, schema = "sirca", 
...
si_au_ref_names_pq <- file.path(Sys.getenv("DATA_DIR"), "sirca",
                                "si_au_ref_names.parquet")

si_au_ref_names <-
  tbl_file(db, si_au_ref_names_pq) |>
  compute(name = "si_au_ref_names")

si_au_prc_daily_pq <- file.path(Sys.getenv("DATA_DIR"), "sirca",
                                "si_au_prc_daily.parquet")
si_au_prc_daily <- tbl_file(db, si_au_prc_daily_pq) 
```
