...
I chose to use parquet files for our output.
...
I regard having a package that does the work satisfies this requirement.

A important principle here is that the code for processing the data is documentation in its own right.
Beyond that the document you are reading now is a form of documentation, as it the documentation in the `ffiec.pq` package.
