...
Typically, researchers need other people to collect these data because of time constraints and either the data are too messy to be collected in an automated fashion with sufficiently low cost and high quality or their collection requires some element of judgement.
...
The Form AP database is contained in the file `form_aps.parquet` available that I have made available at <https://go.unimelb.edu.au/4iq8>.
