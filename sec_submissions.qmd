...
That is, by working through *Empirical Research in Accounting: Tools and Methods* (along with the occasional detour to *R for Data Science*) the reader will achieve a level of proficiency at or above that provided by studying *R for Data Science*.^[*Empirical Research in Accounting: Tools and Methods* was published in print form by CRC Press in December 2024, but remains free online.]
...
More details on the Parquet format can be found in [Chapter 22](https://r4ds.hadley.nz/arrow) of @Wickham:2023aa and a guide to creating a Parquet data repository are provided [here](https://iangow.github.io/far_book/parquet-wrds.html).
