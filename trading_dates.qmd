...
We can identify "missing" dates in 1968 by using `left_join()` of a table of non-weekend dates with the list of trading dates.^[Note that some of these "missing" dates would be public holidays.]
