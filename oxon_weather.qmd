...
The "official" start of summer is the summer solstice (for 2024: 20 June in Oxford and Boston) and the "official" start of winter is the winter solstice (for 2024: 21 December in Oxford and Boston).^[Seasons reckoned in this way are known as **astronomical seasons**. See [here](https://en.wikipedia.org/wiki/Season#Meteorological).]
...
Similarly, summer should start on the first day of the `r max_n_days`-day period that is the hottest such period for a year averaged over a number of years.
...
This implies a spring of `r summer_max + years(1) - spring_max` days and an autumn of `r winter_max - autumn_max` days.
