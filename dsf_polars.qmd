...
However, some of this expressiveness relies on data being in forms that often differs from the data we have (e.g., with date indexes) and pandas can struggle to manipulate the data into those forms, especially with larger data sets.
