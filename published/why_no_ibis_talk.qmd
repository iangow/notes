...
categories: [Python, Ibis, DuckDB, SQL]
keywords:
  - Python
  - Ibis
  - DuckDB
...
::: {.callout-note}
I started in strategy consulting 30 years ago (not even "the data field") and I used SQL a lot back then.
I wrote a little bit about that [here](https://iangow.github.io/sql_book/#sql-and-me).
:::
...
::: {.callout-note}
The [original note](https://www.conterval.com/blog/ibis-for-data-analysis/index.html) took a more complicated approach than the one I use here.
