...
categories: [SAS, WRDS, CRSP, Parquet, Python]
...
Well, not really.
Surely the databases such as CRSP and Compustat that have powered research in accounting and finance since the [beginning of time](https://youtu.be/tRSaz5TIyno?t=500) predate SAS and WRDS.
...
I put this SAS code into a file `g_secd.sas` in my home directory on the WRDS server and ran `qsas g_secd.sas`.
