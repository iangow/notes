...
categories: ["Data curation", dbplyr, SQL, DuckDB]
format:
  html:
    colorlinks: true
    fig-format: png
...
The source code for this note is available [here](https://raw.githubusercontent.com/iangow/notes/main/dbplyr-news.qmd) and the latest version of this PDF is [here](https://raw.githubusercontent.com/iangow/notes/main/dbplyr-news.pdf).
:::
...
But six weeks later, Kirill Müller, a leading `dbplyr` contributor, suggested a (much better) function for consideration.
...
I discuss the merits of CTEs (and of using `dbplyr` to write SQL) [here](ctes.html).]
