...
::: {.abstract}
This note also completes the three-part series of notes written to address gaps in the coverage of @gow2024empirical relative to @Wickham:2023aa.^[My aim with these notes is not to replace existing resources such as @Wickham:2023aa, but to build on them with applied examples using richer data sets.]
...
While the idea of matching identifiers studied in @sec-main-case might seem fairly arcane, this is actually one of the most common use cases for data collection with Google Sheets.
