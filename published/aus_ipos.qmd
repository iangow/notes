...
categories: [Australia, IPOs]
abstract: |
  The purpose of this note is to compile some statistics about IPOs on the Australia Stock Exchange (ASX).
  The source code for this note can be found [here](https://github.com/iangow/notes/blob/main/published/aus_ipos.qmd).
format:
  html:
    colorlinks: true
  typst:
...
#| echo: false
#| label: fig-ipo-ts
#| fig-cap: IPOs by month (May 2017--April 2025)
asx_ipos |>
