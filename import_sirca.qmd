...
### Friends don't let friends use Excel {#sec-friends}
...
Given that `si_au_prc_daily` occupies `r lobstr::obj_size(si_au_prc_daily)` of RAM when loaded, this can be a problem if you have modest computing resources.
...
And of course much of our focus was on **data types**.
So we now turn to the elements of the SLA that we have not addressed.
