...
Given an increase in tariff rates of $\Delta \tau_i$ and passthrough rate of $\varphi$, the increase in prices will be $\tau_i* \varphi$:
...
\end{aligned}
$$
Moving $\Delta \tau_i$ to the left and other terms to the right, we have the famous formula:
