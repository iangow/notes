...
But I read these not so much as five elephants, but as five alternative descriptions of the one elephant, much like the elephant in the parable of the [blind men and an elephant](https://en.wikipedia.org/wiki/Blind_men_and_an_elephant).

What exactly is that elephant in the room?
I argue that Ohlson's five elephants are just alternative perspectives on the same elephant, i.e., p-hacking, which is the practice whereby researchers search for "significant" and "positive" results.^[Here "significant" refers to statistical significance and "positive" refers to results that reject so-called "null hypotheses" and thereby (purportedly) push human knowledge forward.]
But to be sure this is a very big elephant: p-hacking appears to be the predominant mode of research in academic accounting in 2022.
...
These anecdotes draw from actual conversations with colleagues, but I present them in a stylized fashion.

*Anecdote #1*

Me: "Why did you look at $y_1$?
Wouldn't $y_2$ or $y_3$ be the natural things to examine?" Doctoral student(s) at a good school: "I already looked at those.
They didn't work, so I dropped them."

*Anecdote #2*

Me: "Your paper is about $y_1$?
Wouldn't $y_2$ or $y_3$ be the natural things to examine as consequences of $X$?" Senior faculty at a good school: "We already looked at those.
...
But p-hacked results may not even pass the test of **replicability**, which requires that the results can be produced by other authors using in e 
With p-hacked results, small departures from the choices made by the authors along the dimensions described in @Simmons:2011ux can lead to apparent results disappearing (i.e., becoming statistically insignificant).
...
Because p-hacked results depend on  reproducing  can be difficult.
Unless a researcher follows the authors' procedures precisely, statistically significant results can be difficult to replicate.

The fact that much of the published research in accounting uses data sets that are available to most researchers and papers typically include allowing other researchers to *replicate* them in principle.
In practice replication is a costly exercise because ^[See my [LinkedIn post](https://www.linkedin.com/pulse/p-hacking-accounting-research-ian-gow) on this topic.]



One reason that replication is costly is that generally a research seeking to do so would need to invest significant time and effort in writing code to produce reported results.
Only one of the top three accounting journals (Journal of Accounting Research) imposes [requirements](https://onlinelibrary.wiley.com/page/journal/1475679x/homepage/ForAuthors.html) for data and code, but even then rarely do these yield files that permit easy replication of tables found in papers. 
^[The *Journal of Accounting and Economics* merely "[encourages](https://www.elsevier.com/journals/journal-of-accounting-and-economics/0165-4101/guide-for-authors)" authors to share replication files. 
...
Many researchers have negative experiences with attempt@Gow:2022aa
