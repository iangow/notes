...
abstract: "@Ohlson:2022aa draws on his experience in empirical accounting seminars to identify five \"elephants in the room\".
I interpret each of these elephants as either a variant or a symptom of p-hacking.
I provide evidence of the prevalence of p-hacking in accounting research that complements the observations made by @Ohlson:2022aa.
...
I argue that Ohlson's five elephants are simply alternative perspectives on the same elephant, i.e., p-hacking, which is the practice whereby researchers search for "significant" and "positive" results in a way that undermines their significance.^[Here "significant" refers to statistical significance and "positive" refers to results that reject so-called "null hypotheses" and thereby (purportedly) push human knowledge forward.]
...
According to a recent [Financial Times article](https://www.ft.com/content/9025393f-76da-4b8f-9436-4341485c75d0), Campbell Harvey, professor of finance at Duke University, suggests that "at least half of the 400 supposedly market-beating strategies identified in top financial journals over the years are bogus."
...
Second, a journal will typically commit to publish to publishing the resulting study whether there are statistically significant results or not.
...
Fixing a sample for which exist in $t + 4$ and results evaporate.^[These analyses are explored in discussion questions found [here](https://iangow.github.io/far_book/panel-data.html).]
...
See [here](https://iangow.github.io/far_book/regression-discontinuity-designs.html#rdd-in-accounting-research) for details.]
...
We offer initial attempt to incorporate this topic into a PhD curriculum in [our course book](https://iangow.github.io/far_book/natural-revisited.html) and hope that others find ways to build content on this topic into their PhD curricula so as to raise awareness of the issue.
...
@Ohlson:2022aa draws on his experience in empirical accounting seminars to identify five "elephants in the room".
I interpret each of these elephants as either a variant or a symptom of p-hacking.
I provide evidence of the prevalence of p-hacking in accounting research that complements the observations made by @Ohlson:2022aa.

I identify a number of steps that could be taken to reduce p-hacking in accounting research.
I conjecture that facilitating and encouraging replication alone could have profound effects on the quality and quantity of empirical accounting research.
...
Elephant #1 ("Referring to the absence of a Fama-MacBeth analysis") is likely to be seen when researchers are reluctant to adjust their standard errors in ways that make results disappear.
