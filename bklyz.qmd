...
BKLYZ1 do indeed provide such a model. An analyst---whether an academic or a practitioner---can go to the [GitHub page associated with BKLYZ1](https://github.com/JarFraud/FraudDetection/tree/39212b7901fdd61fe420979bfa30f5eadcbee47e), download the code and data, open Matlab, and generate the model.^[In some ways, the requirement for Matlab is unfortunate, as Matlab is proprietary software and offers less transparency than would an implementation usng one of the open-source alternatives, such as Python or R.
