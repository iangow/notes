...
For the task we consider here, we need to use the *Financial Statement and Notes* data set, as this data set includes data on auditor IDs associated with filings.^[Run `source("https://raw.githubusercontent.com/iangow/notes/refs/heads/main/get_dera_notes.R")` to get these data.]
