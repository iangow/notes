...
ccm_link = (
    ccmxpf_lnkhist
    .filter(ccmxpf_lnkhist.linktype.isin(["LC", "LU", "LS"]))
    .filter(ccmxpf_lnkhist.linkprim.isin(["C", "P"]))
    .mutate(
        permno=ccmxpf_lnkhist.lpermno,
        linkenddt=ccmxpf_lnkhist.linkenddt.fill_null(
            ccmxpf_lnkhist.linkenddt.max()
        ),
    )
